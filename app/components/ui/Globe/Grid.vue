...
const globeConfig: GlobeConfig = {
  ...
  shininess: 0.9,
  polygonColor: 'rgba(255,240,255,0.7)',
  ambientLight: '#38bdf8',
...
<template>
  <div class="flex items-center justify-center absolute -left-5 top-36 md:top-40 w-full h-full">
    <div class="max-w-7xl mx-auto w-full relative overflow-hidden h-96 px-4">
      <div class="absolute w-full bottom-0 inset-x-0 h-40 bg-gradient-to-b pointer-events-none select-none from-transparent dark:to-black to-white z-40" />
