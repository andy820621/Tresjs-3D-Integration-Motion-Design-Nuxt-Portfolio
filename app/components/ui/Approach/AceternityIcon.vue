...
<template>
  <div>
    <button class="relative inline-flex overflow-hidden rounded-full p-[1px]">
      ...
      />
      <span
        class="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-5 py-2 text-purple backdrop-blur-3xl font-bold text-2xl"
      >
        {{ order }}
      </span>
    </button>
